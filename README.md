...
## Algorithm
1.Import the dataset and initialize the parameters (weight and bias).
2 Define the cost function and compute gradients using gradient descent.
3 Update the parameters repeatedly until the cost is minimized.
4 Use the trained model to predict the profit for a given city population.
...
## Output:
<img width="1687" height="342" alt="image" src="https://github.com/user-attachments/assets/b4da76c0-9b65-4e48-a4e3-3cb3d9b5f9ba" />
